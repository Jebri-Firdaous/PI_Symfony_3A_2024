 ...
 */
final class Version20240318162056 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande_article (id_commande INT NOT NULL, id_article INT DEFAULT NULL, INDEX id_article (id_article), INDEX id_commande (id_commande), PRIMARY KEY(id_commande)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
